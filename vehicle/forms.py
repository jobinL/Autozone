...
from . import models
from .models import Service, ServiceType, ServiceEntry
...
class ServiceEntryForm(forms.ModelForm):
    ...
    hours_spent = forms.DecimalField(label='Hours Spent', max_digits=5, decimal_places=2)

    class Meta:
        model = ServiceEntry
        fields = ['service_type', 'hours_spent']
...
class AddressForm(forms.ModelForm):
    class Meta:
        model = Address
        fields = ['first_name', 'last_name', 'address_line1', 'address_line2', 'city', 'state', 'postal_code', 'country']
